...
PlayState.prototype.enter = function (game) {
    ...
    let limitLevel = (this.level < this.config.limitLevelIncrease ? this.level : this.config.limitLevelIncrease);
    ...
    //  Create the invaders.
    let ranks = this.config.invaderRanks + 0.1 * limitLevel;
    let files = this.config.invaderFiles + 0.2 * limitLevel;
    let invaders = [];
